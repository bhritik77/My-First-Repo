document.addEventListener('DOMContentLoaded', () => {
    ...
    function isGameOver(){
        ...
        for(let i = 1; i < snake.length; i++){
            if( snake[0].x == snake[i].x && snake[0].y == snake[i].y){
                console.log("snake collides itself");
                return true;
            }
        }
    ...
    function initiateGame(){
        ...
        document.body.insertBefore(scoreBoard, gameArena); // insert scorecard before game arena
        ...
        document.body.appendChild(startButton); // apends start button to body
    }
